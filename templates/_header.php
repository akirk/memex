...
<head>
	...
	<title><?php echo wp_app_title( isset( $memex_title ) ? $memex_title : '' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wp_app_title() returns an esc_html()'d string. ?></title>
	<?php wp_app_head(); ?>
